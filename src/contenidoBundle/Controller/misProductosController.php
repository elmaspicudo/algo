...
use contenidoBundle\Entity\misProductos;
use contenidoBundle\Form\misProductosType;
...
class misProductosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('contenidoBundle:misProductos:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('contenidoBundle:misProductos:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('contenidoBundle:misProductos')->find($id);
        ...
        return $this->render('contenidoBundle:misProductos:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('contenidoBundle:misProductos:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('misproductos_edit', array('id' => $id)));
        }
