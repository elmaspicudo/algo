...
use contabilidadBundle\Entity\factura;
use contabilidadBundle\Form\facturaType;
...
class facturaController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('contabilidadBundle:factura:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('contabilidadBundle:factura')->find($id);
        ...
        return $this->render('contabilidadBundle:factura:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('contabilidadBundle:factura:edit.html.twig', array(
            'entity'      => $entity,
