...
use contabilidadBundle\Entity\empresa;
use contabilidadBundle\Form\empresaType;
...
class empresaController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('contabilidadBundle:empresa:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('contabilidadBundle:empresa')->find($id);
        ...
        return $this->render('contabilidadBundle:empresa:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('contabilidadBundle:empresa:edit.html.twig', array(
            'entity'      => $entity,
